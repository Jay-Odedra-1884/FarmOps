...
function ResetPasswordPage() {
        ...
        return (
            <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex flex-col gap-5 justify-center items-center p-6'>
                <div className='w-full max-w-md flex flex-col justify-center items-center gap-2 bg-white py-12 px-10 rounded-3xl shadow-2xl'>
                    <h2 className='mb-8 font-bold text-4xl text-gray-800 text-center'>Invalid Link</h2>
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex flex-col gap-5 justify-center items-center p-6'>
            <div className='w-full max-w-md flex flex-col justify-center items-center gap-2 bg-white py-12 px-10 rounded-3xl shadow-2xl'>
                <h2 className='mb-8 font-bold text-4xl text-gray-800'>Reset Password</h2>
                ...
                {!success ? (
                    <form onSubmit={handleResetPasswordSubmit} className='w-full flex flex-col gap-5 items-center'>
                        <input
